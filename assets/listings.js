...
const LENSES={
  comm:[['Dubai Hills Estate','Guide & live homes','sky-b','dubai-hills'],['Dubai Marina','Guide & live homes','sky-a','dubai-marina'],['Palm Jumeirah','Guide & live homes','sky-d','palm-jumeirah'],['Downtown Dubai','Guide & live homes','sky-c','downtown']],
...
const COMMUNITIES={
  ...
  'dubai-marina':{name:'Dubai Marina',sky:'sky-a',
  ...
  'palm-jumeirah':{name:'Palm Jumeirah',sky:'sky-d',
  ...
  'downtown':{name:'Downtown Dubai',sky:'sky-c',
